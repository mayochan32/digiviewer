...
画面写真付きの[日本語マニュアル](https://mayochan32.github.io/digiviewer/manual/)を公開しています。フォルダを開くところから、比較、チェック、種名付加、類似写真の評価、クロップ、キャッシュ設定まで説明しています。[ローカル版HTML](docs/manual/index.html)もブラウザで開いて読めます。GitHub Pagesの紹介ページにもマニュアルへのリンクがあります。
...
マニュアルの本文・画面写真は `docs/manual/` でGit管理します。機能変更時は該当する説明と対象バージョンを更新します。更新時の確認事項は [マニュアル更新ガイド](docs/manual/README.md) にあります。
